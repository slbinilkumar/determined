    ...
    def step_optimizer(
        ...
        Arguments:
            ...
            auto_zero_grads(bool, optional): Automatically zero out gradients automatically
                after stepping the optimizer. If set to be false, you need to call
                ``optimizer.zero_grad()`` manually. Note that if
                ``optimizations.aggregation_frequency`` is larger than 1, you can only
                set it to be true.
        """
